...
Definition testNEA : Automat := 
  mk_auto (Finite_Set 2) (Finite_Set 2) (F1 1) ((FS 1 (F1 0))::nil) (fun x y => nil).
...
Definition test2NEA : Automat := 
  mk_NEA 3 4 (F1 2) nil (fun q x => nil).
...
(*
Lemma lulu : forall f : A -> B, (not (injective f)) -> (notInjective f).
Proof.
  intros.
  unfold notInjective.
...
(* Sowohl x als auch x0 sind Hypothesen und vom Typ A  
   - muss man nur matchen *)
  simpl.
  symmetry.
  reflexivity.
